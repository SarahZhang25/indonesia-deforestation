# file for visualizing sample of points of the border of indonesia and the different potential square boundaries
# result example shown in slide 4 in cells.pptx
# need to zoom in a lot to see the squares
